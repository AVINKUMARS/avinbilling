...
export function CrmDashboard() {
  ...
  return <div className="mt-7 space-y-6">
    ...
    {creating && <SaveForm onSubmit={createLead} className="rounded-2xl border border-brand-200 bg-white p-5 shadow-card"><div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4"><input name="name" required placeholder="Customer name" className="rounded-xl border border-slate-300 px-4 py-3" /><input name="phone" required placeholder="Phone" className="rounded-xl border border-slate-300 px-4 py-3" /><input name="email" type="email" placeholder="Email" className="rounded-xl border border-slate-300 px-4 py-3" /><input name="source" placeholder="Source: referral, website…" className="rounded-xl border border-slate-300 px-4 py-3" /><input name="budget" type="number" min="0" step="0.01" placeholder="Expected budget ₹" className="rounded-xl border border-slate-300 px-4 py-3" /><input name="notes" placeholder="Requirement notes" className="rounded-xl border border-slate-300 px-4 py-3 sm:col-span-2" /></div><button className="mt-4 rounded-xl bg-slate-900 px-5 py-2.5 text-sm font-bold text-white">Save lead</button></SaveForm>}
